...
<!-- </section>  -->
         ...
         <section class="mt-10 ">
                ...
                <form action="{{route('users.update',['user' => $users])}}"  method="POST" class= "flex flex-col">
                    @method('PUT')
                              ...
                              <div class=" shadow-lg shadow-blue-500/50 relative py-3 sm:max-w-xl sm:mx-auto w-full  bg-blue-500 rounded-xl">
                                ...
                                <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                                  <div class="max-w-md mx-auto">
                                    <div>
                                      <h1 class=" font-sans-saref text-center text-xl font-bold shadow-lg shadow-green-200/50"> {{$users->name}}</h1>
                                    ...
                                    <div class="divide-y divide-gray-200  mt-5">
                                      <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                        <div class="relative">
                                          ...
                                          <input autocomplete="off" id="name" name="name" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600" value={{$users->name}} />
                                    ...
                                    <div class="divide-y divide-gray-200 ">
                                      ...
                                      <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                        <div class="relative">
                                          <input autocomplete="off" name="password_confirmation" type="password" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:border-blue-600"  value={{$users->confirm_password}}  />
                                             ...
                                             <div class="relative w-full mb-3 mt-7">
                                               <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlfor="grid-password">
                                                ...
                                                <select  name="status" class="  focus:ring-1 focus:ring-blue-600  block appearance-none w-full bg-white-200 border border-white-200 text-gray-700 py-3 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                                                      <option value="" {{$users->status == "" ? 'selected' : ''}}>Select Status</option>
                                                      ...
                                                      <!-- <option value="" {{$users->status == "" ? 'selected' : ''}}></option>
                                                      <option value="Active" {{$users->status == 'Active' ? 'selected' : ''}}>Active </option>
                                                      <option value="Inactive" value={{$users->status == 'Inactive' ? 'selected' : ''}}>Inactive</option> -->
                                        ...
                                        <div class="relative">
                                          <button class="bg-blue-500 text-white rounded-md px-2 py-1 hover:bg-green-700 text-white w-full py-2 rounded-lg shadow-2xl hover: shadow-xl transition duration-200" type="submit">Update</button>
