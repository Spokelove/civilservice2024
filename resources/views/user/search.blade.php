           ...
           <div class = "grow h-full flex items-center justify-center "></div>
             ...
             <form action="{{ route('users.search') }}"  method="GET" class="flex items-center">
                   ...
                   <input
                    ...
                    <!-- <form action="{{ route('users.search') }}"  method="GET" class="flex items-center"> -->
                                            <!-- Your search bar input -->
                                     <!-- <input type="search" class="form-control mr-sm-2" name="query" placeholder="Search"> 
                                    <button type="submit" class="btn btn-outline-succes my-2 my-sm-0 bg-blue-200">
                                         Search
                                          </button> -->
                                             <!-- </form>         -->
...
<div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8">
                ...
                <div class="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg mt-5">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Created At</th>
                                 ...
                                 <th class="px-6 py-3 border-b-2 border-gray-300 text-left-5 text-sm leading-4 text-blue-500 tracking-wider">Actions</th> 
...
<!-- 
                                    <td class="px-6 py-4 whitespace-no-wrap text-left border-b border-gray-500 text-sm leading-5">
                                         <a href ="{{url('Update')}}" button class="px-2 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">Update</button></a>
                                    </td> -->
...
<!-- 
           ...
           <a href ="{{url('/Management')}}"  button class="  space-x-px space-x-36 mb-3  bg-blue-500 text-white active:bg-green-900 text-xs px-2 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button">
            Refresh
            </button></a> 
